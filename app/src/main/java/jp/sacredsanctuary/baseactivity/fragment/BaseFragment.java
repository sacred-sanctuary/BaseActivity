...
public class BaseFragment extends Fragment {
    ...
    public void onHiddenChanged(boolean hidden) {
        LogUtil.V(TAG, CLASS_NAME, "onHiddenChanged() [I N] ");
        super.onHiddenChanged(hidden);
        LogUtil.V(TAG, CLASS_NAME, "onHiddenChanged() [OUT] ");
    }
    ...
    public void onInflate(AttributeSet attrs, Bundle savedInstanceState) {
        LogUtil.V(TAG, CLASS_NAME, "onInflate() [I N] ");
        super.onInflate(attrs, savedInstanceState);
        LogUtil.V(TAG, CLASS_NAME, "onInflate() [OUT] ");
    }
    ...
    public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
        LogUtil.V(TAG, CLASS_NAME, "onInflate(Context) [I N] ");
        super.onInflate(context, attrs, savedInstanceState);
        LogUtil.V(TAG, CLASS_NAME, "onInflate(Context) [OUT] ");
    }
    ...
    public void onInflate(Activity activity, AttributeSet attrs, Bundle savedInstanceState) {
        LogUtil.V(TAG, CLASS_NAME, "onInflate(Activity) [I N] ");
        super.onInflate(activity, attrs, savedInstanceState);
        LogUtil.V(TAG, CLASS_NAME, "onInflate(Activity) [OUT] ");
    }
    ...
    public void onAttachFragment(Fragment childFragment) {
        LogUtil.V(TAG, CLASS_NAME, "onAttachFragment(Activity) [I N] ");
        super.onAttachFragment(childFragment);
        LogUtil.V(TAG, CLASS_NAME, "onAttachFragment(Activity) [OUT] ");
    }
    ...
    public void onAttach(Context context) {
        LogUtil.V(TAG, CLASS_NAME, "onAttach(Context) [I N] ");
        super.onAttach(context);
        LogUtil.V(TAG, CLASS_NAME, "onAttach(Context) [OUT] ");
    }
    ...
    public void onAttach(Activity activity) {
        LogUtil.V(TAG, CLASS_NAME, "onAttach(Activity) [I N] ");
        super.onAttach(activity);
        LogUtil.V(TAG, CLASS_NAME, "onAttach(Activity) [OUT] ");
    }
    ...
    public Animator onCreateAnimator(int transit, boolean enter, int nextAnim) {
        LogUtil.V(TAG, CLASS_NAME, "onCreateAnimator() [I N] ");
        Animator animator = super.onCreateAnimator(transit, enter, nextAnim);
        LogUtil.V(TAG, CLASS_NAME, "onCreateAnimator() [OUT] ");
        return animator;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        LogUtil.V(TAG, CLASS_NAME, "onViewCreated() [I N] ");
        super.onViewCreated(view, savedInstanceState);
        LogUtil.V(TAG, CLASS_NAME, "onViewCreated() [OUT] ");
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        LogUtil.V(TAG, CLASS_NAME, "onActivityCreated() [I N] ");
        super.onActivityCreated(savedInstanceState);
        LogUtil.V(TAG, CLASS_NAME, "onActivityCreated() [OUT] ");
    }
    ...
    public void onViewStateRestored(Bundle savedInstanceState) {
        LogUtil.V(TAG, CLASS_NAME, "onViewStateRestored() [I N] ");
        super.onViewStateRestored(savedInstanceState);
        LogUtil.V(TAG, CLASS_NAME, "onViewStateRestored() [OUT] ");
    }
    ...
    public void onMultiWindowModeChanged(boolean isInMultiWindowMode) {
        LogUtil.V(TAG, CLASS_NAME, "onMultiWindowModeChanged() [I N] ");
        super.onMultiWindowModeChanged(isInMultiWindowMode);
        LogUtil.V(TAG, CLASS_NAME, "onMultiWindowModeChanged() [OUT] ");
    }
    ...
    public void onPictureInPictureModeChanged(boolean isInPictureInPictureMode) {
        LogUtil.V(TAG, CLASS_NAME, "onPictureInPictureModeChanged() [I N] ");
        super.onPictureInPictureModeChanged(isInPictureInPictureMode);
        LogUtil.V(TAG, CLASS_NAME, "onPictureInPictureModeChanged() [OUT] ");
    }
    ...
    public void onDestroyView() {
        LogUtil.V(TAG, CLASS_NAME, "onDestroyView() [I N] ");
        super.onDestroyView();
        LogUtil.V(TAG, CLASS_NAME, "onDestroyView() [OUT] ");
    }
    ...
    public void onDetach() {
        LogUtil.V(TAG, CLASS_NAME, "onDetach() [I N] ");
        super.onDetach();
        LogUtil.V(TAG, CLASS_NAME, "onDetach() [OUT] ");
    }
    ...
    public void onDestroyOptionsMenu() {
        LogUtil.V(TAG, CLASS_NAME, "onDestroyOptionsMenu() [I N] ");
        super.onDestroyOptionsMenu();
        LogUtil.V(TAG, CLASS_NAME, "onDestroyOptionsMenu() [OUT] ");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        LogUtil.V(TAG, CLASS_NAME, "onOptionsItemSelected() [OUT] ret:" + ret);
        return ret;
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        LogUtil.V(TAG, CLASS_NAME, "onContextItemSelected() [OUT] ret:" + ret);
        return ret;
    }
}
